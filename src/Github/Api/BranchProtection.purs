...
getBranchProtection accessToken org repo branch = -- Make the request and interpret the response
...
updateBranchProtection accessToken owner repo branch updateData = -- Make the request and interpret the response
  request req >>= transformResponse
  where
  endpointUrl :: String
...
newtype UpdateBranchProtectionData
  = UpdateBranchProtectionData
...
removeBranchProtection accessToken owner repo branch = -- Make the request and interpret the response
  request req >>= transformResponse
  where
  endpointUrl :: String
  endpointUrl = api $ "repos/" <> unwrap owner <> "/" <> unwrap repo <> "/branches/" <> unwrap branch <> "/protection"
...
-------------------------------------------------------------------------------
-- ERRORS
type BranchNotProtected ρ
  = ( branchNotProtected ∷ BranchNotProtectedImpl | ρ )

data BranchNotProtectedImpl
  = BranchNotProtectedImpl
...
-------------------------------------------------------------------------------
type BranchNotFound ρ
  = ( branchNotFound ∷ BranchNotFoundImpl | ρ )

data BranchNotFoundImpl
  = BranchNotFoundImpl OrgName RepoName BranchName
