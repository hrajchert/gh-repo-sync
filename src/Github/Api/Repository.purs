...
getRepo maybeAccessToken org repo = -- Make the request and interpret the response
...
-- ERRORS
type RepoNotFound ρ
  = ( repoNotFound ∷ RepoNotFoundImpl | ρ )

data RepoNotFoundImpl
  = RepoNotFoundImpl OrgName RepoName
